...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'energia' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'energia' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'energia' ),
			'200'       => esc_attr__( 'Light 200', 'energia' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'energia' ),
			'300'       => esc_attr__( 'Book 300', 'energia' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'energia' ),
			'400'       => esc_attr__( 'Normal 400', 'energia' ),
			'regular'   => esc_attr__( 'Normal 400', 'energia' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'energia' ),
			'500'       => esc_attr__( 'Medium 500', 'energia' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'energia' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'energia' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'energia' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'energia' ),
			'700'       => esc_attr__( 'Bold 700', 'energia' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'energia' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'energia' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'energia' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'energia' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'energia' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'energia' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'energia' ),
		);
	}
