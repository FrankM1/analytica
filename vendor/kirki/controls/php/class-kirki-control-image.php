...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'energia' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'energia' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'energia' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'energia' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'energia' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'energia' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'energia' ); ?>',
		} );
		#>
		<label>
