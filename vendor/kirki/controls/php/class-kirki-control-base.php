...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected'   => esc_attr__( 'No File Selected', 'energia' ),
				'remove'           => esc_attr__( 'Remove', 'energia' ),
				'default'          => esc_attr__( 'Default', 'energia' ),
				'selectFile'       => esc_attr__( 'Select File', 'energia' ),
				'standardFonts'    => esc_attr__( 'Standard Fonts', 'energia' ),
				'googleFonts'      => esc_attr__( 'Google Fonts', 'energia' ),
				'defaultCSSValues' => esc_attr__( 'Default CSS Values', 'energia' ),
			)
		);
