...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'energia' ),
				'change'       => esc_attr__( 'Change image', 'energia' ),
				'default'      => esc_attr__( 'Default', 'energia' ),
				'remove'       => esc_attr__( 'Remove', 'energia' ),
				'placeholder'  => esc_attr__( 'No image selected', 'energia' ),
				'frame_title'  => esc_attr__( 'Select image', 'energia' ),
				'frame_button' => esc_attr__( 'Choose image', 'energia' ),
			)
		);
	}
