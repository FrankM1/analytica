...
class About_Page {
     ...
     *
     * @var About_Page $instance The  About_Page instance.
     */
    private static $instance;

    /**
     * The Main About_Page instance.
     *
     * We make sure that only one instance of About_Page exists in the memory at one time.
     *
     * @param array $config The configuration array.
     */
    public static function init( $config ) {
        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof About_Page ) ) {
            self::$instance = new About_Page;
    ...
    public function get_plugin_icon( $arr ) {
        ...
        if ( ! empty( $arr['svg'] ) ) {
            ...
            $plugin_icon_url = get_template_directory_uri() . '/includes/admin/about-page/images/placeholder_plugin.png';
        }
