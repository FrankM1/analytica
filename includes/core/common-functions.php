 ...
 * Foreground Color
 */
if ( ! function_exists( 'analytica_get_foreground_color' ) ) {
 ...
 * Generate CSS
 */
if ( ! function_exists( 'analytica_css' ) ) {
 ...
 * Get Font Size value
 */
if ( ! function_exists( 'analytica_responsive_font' ) ) {
 ...
 * Get Font Size value
 */
if ( ! function_exists( 'analytica_get_font_css_value' ) ) {
 ...
 * Get Font family
 */
if ( ! function_exists( 'analytica_get_font_family' ) ) {
	...
	function analytica_get_font_family( $value = '' ) {
		$system_fonts = Analytica_Font_Families::get_system_fonts();
 ...
 * Get CSS value
 */
if ( ! function_exists( 'analytica_get_css_value' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_background_obj' ) ) {
 ...
 * Parse CSS
 */
if ( ! function_exists( 'analytica_parse_css' ) ) {
	 ...
	 */
	function analytica_parse_css( $css_output = array(), $min_media = '', $max_media = '' ) {
 ...
 */
if ( ! function_exists( 'analytica_get_option' ) ) {
	...
	function analytica_get_option( $option, $default = '', $deprecated = '' ) {
		...
		$theme_options = Analytica_Theme_Options::get_options();
		 ...
		 * $option is the name of the Analytica Setting, Refer Analytica_Theme_Options::defaults() for option names from the theme.
		 *
		 * @since  1.0.20
		 * @var Mixed.
		 */
 ...
 */
if ( ! function_exists( 'analytica_get_option_meta' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_post_id' ) ) {
	...
	function analytica_get_post_id( $post_id_override = '' ) {
		...
		if ( null == Analytica_Theme_Options::$post_id ) {
			global $post;
			...
			Analytica_Theme_Options::$post_id = $post_id;
		}

		return apply_filters( 'analytica_get_post_id', Analytica_Theme_Options::$post_id, $post_id_override );
	}
}
 ...
 */
if ( ! function_exists( 'analytica_primary_class' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_primary_class' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_secondary_class' ) ) {
 ...
 * Retrieve the classes for the secondary element as an array.
 */
if ( ! function_exists( 'get_analytica_secondary_class' ) ) {
 ...
 * Get post format
 */
if ( ! function_exists( 'analytica_get_post_format' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_the_post_title' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_the_title' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_the_title' ) ) {
 ...
 * Archive Page Title
 */
if ( ! function_exists( 'analytica_archive_page_info' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_adjust_brightness' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_hex_to_rgba' ) ) :
...
if ( ! function_exists( 'analytica_enable_page_builder_compatibility' ) ) :

	/**
	 * Allow filter to enable/disable page builder compatibility.
	 *
	 * @see  https://wpanalytica.com/docs/recommended-settings-beaver-builder-analytica/
	 * @see  https://wpanalytica.com/docs/recommended-settings-for-elementor/
	 *
	 * @since  1.2.2
	 * @return  bool True - If the page builder compatibility is enabled. False - IF the page builder compatibility is disabled.
	 */
	function analytica_enable_page_builder_compatibility() {
		return apply_filters( 'analytica_enable_page_builder_compatibility', true );
	}

endif;


if ( ! function_exists( 'analytica_get_pro_url' ) ) :
	/**
	 ...
	 * @return mixed
	 */
	function analytica_get_pro_url( $url, $source = '', $medium = '', $campaign = '' ) {
