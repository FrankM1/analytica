...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[shop-grids]', array(
			'default'           => array(
				'desktop' => 4,
				'tablet'  => 3,
				'mobile'  => 2,
	...
	$wp_customize->add_control(
		new Analytica_Control_Responsive_Slider(
			$wp_customize, ANALYTICA_THEME_SETTINGS . '[shop-grids]', array(
	 ...
	 */
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[shop-no-of-products]', array(
	 ...
	 */
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[shop-hover-style]', array(
	 ...
	 */
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[shop-product-structure]', array(
	...
	$wp_customize->add_control(
		new Analytica_Control_Sortable(
			$wp_customize, ANALYTICA_THEME_SETTINGS . '[shop-product-structure]', array(
				'type'     => 'ast-sortable',
				'section'  => 'section-woo-shop',
				'priority' => 30,
	...
	$wp_customize->add_control(
		new Analytica_Control_Divider(
			$wp_customize, ANALYTICA_THEME_SETTINGS . '[shop-archive-width-divider]', array(
				'section'  => 'section-woo-shop',
				'type'     => 'ast-divider',
				'priority' => 220,
				'settings' => array(),
	 ...
	 */
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[shop-archive-width]', array(
	 ...
	 */
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[shop-archive-max-width]', array(
			'default'           => 1200,
			'type'              => 'option',
	...
	$wp_customize->add_control(
		new Analytica_Control_Slider(
			$wp_customize, ANALYTICA_THEME_SETTINGS . '[shop-archive-max-width]', array(
				'type'        => 'ast-slider',
				'section'     => 'section-woo-shop',
				'priority'    => 225,
