...
if ( ! class_exists( 'Analytica_Woocommerce' ) ) :
	...
	class Analytica_Woocommerce {
		...
		public function __construct() {
			...
			require_once ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/woocommerce-common-functions.php';
		...
		function woo_filter_style( $styles ) {
			...
			$css_uri = ANALYTICA_THEME_URI . 'assets/css/' . $dir_name . '/compatibility/woocommerce/';
			...
			$styles = array(
				'woocommerce-layout'      => array(
					...
					'deps'    => '',
					'version' => ANALYTICA_THEME_VERSION,
					'media'   => 'all',
					'has_rtl' => true,
				),
		...
		function customize_register( $wp_customize ) {
			 ...
			 */
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/register-panels-and-sections.php';

			/**
			 * Sections
			 */
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/sections/section-container.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/sections/section-sidebar.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/sections/layout/woo-shop.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/sections/layout/woo-shop-single.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/sections/layout/woo-shop-cart.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/woocommerce/customizer/sections/layout/woo-general.php';
