...
/**
 * Analytica Ubermenu Compatibility
 */
if ( ! class_exists( 'Analytica_Ubermeu' ) ) :
	...
	class Analytica_Ubermeu {
		...
		public function __construct() {
			add_filter( 'analytica_enable_mobile_menu_buttons', array( $this, 'disable_primary_menu_toggle' ), 30 );
		}

		/**
		 * Disable the Mobile Menu toggles from Analytica if Uber Menu is used.
		 *
		 * @since  1.1.7
 ...
 */
Analytica_Ubermeu::get_instance();
