...
if ( ! class_exists( 'Analytica_LifterLMS' ) ) :
	...
	class Analytica_LifterLMS {
		...
		function customize_register( $wp_customize ) {
			 ...
			 */
			require ANALYTICA_THEME_DIR . 'includes/compatibility/lifterlms/customizer/register-panels-and-sections.php';

			/**
			 * Sections
			 */
			require ANALYTICA_THEME_DIR . 'includes/compatibility/lifterlms/customizer/sections/section-container.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/lifterlms/customizer/sections/section-sidebar.php';
			require ANALYTICA_THEME_DIR . 'includes/compatibility/lifterlms/customizer/sections/layout/section-general.php';
		}
		...
		function add_styles( $assets ) {
			$assets['css']['analytica-lifterlms'] = 'compatibility/lifterlms';
			return $assets;
		}
