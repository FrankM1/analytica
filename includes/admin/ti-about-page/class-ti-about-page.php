	...
	class TI_About_Page {
		...
		public function get_plugin_icon( $arr ) {
			...
			if ( ! empty( $arr['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/includes/admin/ti-about-page/images/placeholder_plugin.png';
			}
...
//						}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'ti-about-page-css', get_template_directory_uri() . '/includes/admin/ti-about-page/css/ti_about_page_css.css' );

			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {

				wp_enqueue_script( 'ti-about-page-js', get_template_directory_uri() . '/includes/admin/ti-about-page/js/ti_about_page_scripts.js', array( 'jquery' ) );
