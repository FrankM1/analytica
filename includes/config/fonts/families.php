...
final class Families {
    ...
    public static function get_google_fonts() {
        ...
        if ( empty( self::$google_fonts ) ) {
            ...
            $google_fonts_file = apply_filters( 'analytica_google_fonts_json_file', analytica()->theme_dir . '/assets/fonts/google-fonts.json' );

            if ( ! file_exists( analytica()->theme_dir . '/assets/fonts/google-fonts.json' ) ) {
                return array();
            }
