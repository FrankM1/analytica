 ...
 */
if ( ! function_exists( 'analytica_blog_body_classes' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_post_class_blog_grid' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_blog_get_post_meta' ) ) {
 ...
 * Featured post meta.
 */
if ( ! function_exists( 'analytica_blog_post_get_featured_item' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_blog_post_thumbnai_and_title_order' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_blog_post_thumbnail' ) ) {
	...
	function analytica_get_blog_post_thumbnail( $type = 'archive' ) {
		...
		if ( 'archive' === $type ) {
			// Blog Post Featured Image.
			analytica_get_post_thumbnail( '<div class="ast-blog-featured-section post-thumb ast-col-md-12">', '</div>' );
		} elseif ( 'single' === $type ) {
			// Single Post Featured Image.
 ...
 */
if ( ! function_exists( 'analytica_get_blog_post_title_meta' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_single_post_title_meta' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_audios_from_post' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_video_from_post' ) ) {
