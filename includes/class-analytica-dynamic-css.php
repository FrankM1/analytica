 ...
 * Dynamic CSS
 */
if ( ! class_exists( 'Analytica_Dynamic_CSS' ) ) {

	/**
	 * Dynamic CSS
	 */
	class Analytica_Dynamic_CSS {
		...
		static public function return_output() {
			...
			if ( apply_filters( 'analytica_enable_default_fonts', true ) ) {
				$analytica_fonts          = '@font-face {';
					...
					$analytica_fonts     .= 'src: url( ' . ANALYTICA_THEME_URI . 'assets/fonts/analytica.woff) format("woff"),';
						$analytica_fonts .= 'url( ' . ANALYTICA_THEME_URI . 'assets/fonts/analytica.ttf) format("truetype"),';
						$analytica_fonts .= 'url( ' . ANALYTICA_THEME_URI . 'assets/fonts/analytica.svg#analytica) format("svg");';
