...
if ( ! class_exists( 'Analytica_LearnDash' ) ) :
	...
	class Analytica_LearnDash {
		...
		function customize_register( $wp_customize ) {
			 ...
			 */
			require analytica()->theme_dir . '/includes/extensions/learndash/customizer/register-panels-and-sections.php';

			/**
			 * Sections
			 */
			require analytica()->theme_dir . '/includes/extensions/learndash/customizer/sections/section-container.php';
			require analytica()->theme_dir . '/includes/extensions/learndash/customizer/sections/section-sidebar.php';
			require analytica()->theme_dir . '/includes/extensions/learndash/customizer/sections/layout/section-general.php';
		}
		...
		function add_styles( $assets ) {
			$assets['css']['analytica-learndash'] = 'extensions/learndash';
			return $assets;
		}
