...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_setting(
		analytica()->theme_option_name . '[llms-course-grid]', array(
			'default'           => array(
				'desktop' => 3,
				'tablet'  => 2,
				'mobile'  => 1,
	...
	$wp_customize->add_control(
		new Analytica_Control_Responsive_Slider(
			$wp_customize, analytica()->theme_option_name . '[llms-course-grid]', array(
	 ...
	 */
	$wp_customize->add_setting(
		analytica()->theme_option_name . '[llms-membership-grid]', array(
			'default'           => array(
				'desktop' => 3,
				'tablet'  => 2,
				'mobile'  => 1,
	...
	$wp_customize->add_control(
		new Analytica_Control_Responsive_Slider(
			$wp_customize, analytica()->theme_option_name . '[llms-membership-grid]', array(
				'type'        => 'ast-responsive-slider',
				'section'     => 'section-lifterlms',
