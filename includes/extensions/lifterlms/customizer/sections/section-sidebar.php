...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_control(
		new Analytica_Control_Divider(
			$wp_customize, analytica()->theme_option_name . '[lifterlms-course-lesson-sidebar-layout-divider]', array(
	...
	$wp_customize->add_setting(
		analytica()->theme_option_name . '[lifterlms-sidebar-layout]', array(
	 ...
	 */
	$wp_customize->add_setting(
		analytica()->theme_option_name . '[lifterlms-course-lesson-sidebar-layout]', array(
