...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_control(
		new Analytica_Control_Divider(
			$wp_customize, ANALYTICA_THEME_SETTINGS . '[divider-section-header-single-title]', array(
				'type'     => 'ast-divider',
				'section'  => 'section-single-typo',
				'priority' => 5,
				'label'    => __( 'Single Post / Page Title', 'analytica' ),
				'settings' => array(),
			)
		)
	);
	...
	$wp_customize->add_setting(
		ANALYTICA_THEME_SETTINGS . '[font-size-entry-title]', array(
			'default'           => analytica_get_option( 'font-size-entry-title' ),
			'type'              => 'option',
	...
	$wp_customize->add_control(
		new Analytica_Control_Responsive(
			$wp_customize, ANALYTICA_THEME_SETTINGS . '[font-size-entry-title]', array(
				'type'        => 'ast-responsive',
				'section'     => 'section-single-typo',
				'priority'    => 10,
	...
	if ( ! defined( 'ANALYTICA_EXT_VER' ) ) {
		...
		$wp_customize->add_control(
			new Analytica_Control_Divider(
				$wp_customize, ANALYTICA_THEME_SETTINGS . '[ast-sngle-blog-typography-more-feature-divider]', array(
					'type'     => 'ast-divider',
					'section'  => 'section-single-typo',
					'priority' => 15,
					'settings' => array(),
		...
		$wp_customize->add_control(
			new Analytica_Control_Description(
				$wp_customize, ANALYTICA_THEME_SETTINGS . '[ast-sngle-blog-typography-more-feature-description]', array(
