 ...
 */
class Analytica_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		$css_uri = ANALYTICA_THEME_URI . 'includes/customizer/custom-controls/responsive-slider/';
		$js_uri  = ANALYTICA_THEME_URI . 'includes/customizer/custom-controls/responsive-slider/';

		wp_enqueue_script( 'analytica-responsive-slider', $js_uri . 'responsive-slider.js', array( 'jquery', 'customize-base' ), ANALYTICA_THEME_VERSION, true );
		wp_enqueue_style( 'analytica-responsive-slider', $css_uri . 'responsive-slider.css', null, ANALYTICA_THEME_VERSION );
	}
