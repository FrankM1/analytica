 ...
 * Schema for <body> tag.
 */
if ( ! function_exists( 'analytica_schema_body' ) ) :
 ...
 */
if ( ! function_exists( 'analytica_body_classes' ) ) {
	...
	function analytica_body_classes( $classes ) {
		...
		$classes[] = esc_attr( 'analytica-' . ANALYTICA_THEME_VERSION );
 ...
 */
if ( ! function_exists( 'analytica_number_pagination' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_logo' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_dynamic_header_content' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_search' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_custom_html' ) ) {
	...
	function analytica_get_custom_html( $option_name = '' ) {
		...
		if ( ! empty( $custom_html_content ) ) {
			...
			$custom_html = '<a href="' . esc_url( admin_url( 'customize.php?autofocus[control]=' . ANALYTICA_THEME_SETTINGS . '[' . $option_name . ']' ) ) . '">' . __( 'Add Custom HTML', 'analytica' ) . '</a>';
		}
 ...
 */
if ( ! function_exists( 'analytica_get_custom_widget' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_small_footer' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_small_footer_custom_text' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_small_footer_menu' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_header_markup' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_site_branding_markup' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_toggle_buttons_markup' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_primary_navigation_markup' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_footer_markup' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_header_break_point' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_body_font_family' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_edit_post_link' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_header_classes' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_footer_classes' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_header_breakpoint_style' ) ) {
	...
	function analytica_header_breakpoint_style() {
		...
		$dynamic_css = Analytica_Enqueue_Scripts::trim_css( $dynamic_css );
 ...
 */
if ( ! function_exists( 'analytica_comment_form_default_fields_markup' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_comment_form_default_markup' ) ) {
 ...
 * Function to filter comment form arguments
 */
if ( ! function_exists( 'analytica_404_page_layout' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_content_layout' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_the_excerpt' ) ) {
 ...
 * Display Sidebars
 */
if ( ! function_exists( 'analytica_get_sidebar' ) ) {
	/**
	 * Get Sidebar
	 *
	 * @since 1.0.1.1
 ...
 * Get Footer widgets
 */
if ( ! function_exists( 'analytica_get_footer_widget' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_entry_header_class' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_post_thumbnail' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_check_is_ie' ) ) :
 ...
 * Replace heade logo.
 */
if ( ! function_exists( 'analytica_replace_header_logo' ) ) :
 ...
 * Function to check if it is Internet Explorer
 */
if ( ! function_exists( 'analytica_replace_header_attr' ) ) :
 ...
 */
if ( ! function_exists( 'analytica_color_palette' ) ) :
...
if ( ! function_exists( 'analytica_get_theme_name' ) ) :
...
if ( ! function_exists( 'analytica_strposa' ) ) :
...
if ( ! function_exists( 'analytica_get_addon_name' ) ) :
