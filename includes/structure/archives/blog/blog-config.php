 ...
 * @return  post meta
 */
if ( ! function_exists( 'analytica_get_post_meta' ) ) {
	 ...
	 */
	function analytica_get_post_meta( $post_meta, $separator = '/' ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_post_date' ) ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_post_author' ) ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_post_link' ) ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_post_comments' ) ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_post_tags' ) ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_post_categories' ) ) {
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'analytica_blog_layout_class' ) ) {
 ...
 */
if ( ! function_exists( 'analytica_get_blog_layout_class' ) ) {
 ...
 * @return html
 */
if ( ! function_exists( 'analytica_the_content_more_link' ) ) {
